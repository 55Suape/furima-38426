...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'passwordは英数字をそれぞれ少なくとも1文字ずつ含まないと登録できない' do
      ...
      it 'last_nameが「全角」でなければ登録できない' do
        @user.last_name = 'oonani'
        @user.valid?
      ...
      it 'first_nameが「全角」でなければ登録できない' do
        @user.first_name = 'shohei'
        @user.valid?
      ...
      it 'last_name_kanaが「全角カタカナ」でなければ登録できない' do
        @user.last_name_kana = 'ｵｵﾀﾆ'
        @user.valid?
      ...
      it 'first_name_kanaが「全角カタカナ」でなければ登録できない' do
